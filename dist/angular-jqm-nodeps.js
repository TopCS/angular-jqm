/*! angular-jqm - v0.0.1-SNAPSHOT - 2013-10-21
...
jqmModule.directive('jqmLiCount', [function() {
  return {
    ...
    transclude: true,
    require: '^jqmLiLink',
    template: '<span class="ui-li-count ui-btn-corner-all" ng-transclude></span>',
...
jqmModule.directive('jqmLiThumb', [function() {
  return {
    ...
    replace: true,
    require: '^jqmLiLink',
    template: '<img class="ui-li-thumb">',
    link: function(scope, elm, attr, jqmLiLinkCtrl) {
...
jqmModule.directive('jqmLoadDialog', ['$animate', '$rootElement', function($animate, $rootElement) {
  return {
    ...
    transclude: true,
    replace: true,
    template: '<div jqm-scope-as="jqmLoad"  jqm-class="\'ui-loader ui-corner-all ui-body-\' + $scopeAs.jqmLoad.$theme + \' \' +    ($scopeAs.jqmLoad.hasContent ? \'ui-loader-verbose\' : \'ui-loader-default\')">  <span class="ui-icon {{$scopeAs.jqmLoad.icon}}"></span>  <h1></h1></div>',
    scope: {
      icon: '@'
    },
...
function($position, $parse, $compile, $rootScope, $animate) {
  ...
  return {
    ...
    replace: true,
    transclude: true,
    template: '<div jqm-scope-as="jqmPopup" class="ui-popup-container ng-hide"  jqm-class="{\'ui-popup-open\': $scopeAs.jqmPopup.opened}">  <div class="ui-popup ui-body-{{$theme}}"    jqm-class="{\'ui-overlay-shadow\': $scopeAs.jqmPopup.shadow, \'ui-corner-all\': $scopeAs.jqmPopup.corners}"    ng-transclude>  </div></div>',
    require: '^?jqmPage',
    scope: {
      corners: '@',
      shadow: '@',
...
jqmModule.directive('jqmPopupOverlay', function() {
  return {
    restrict: 'A',
    replace: true,
    template: '<div class="ui-popup-screen ui-overlay-{{$scopeAs.jqmPopup.overlayTheme || $scopeAs.jqmPopup.$theme}}"   jqm-class="{\'ui-screen-hidden\': !$scopeAs.jqmPopup.opened, \'in\': $scopeAs.jqmPopup.opened}"  ng-click="$scopeAs.jqmPopup.hide()"></div>'
  };
});
